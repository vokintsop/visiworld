...
int main( int argc, char* argv[] )
{
...
#if 0 
  //string data = "/testdata/reika/input/reika.01/left0000.avi"; start_frame = 0; // по пр€мой возле сбербанка за черным бмв
  string data = "/testdata/reika/input/reika.01/left0001.avi";  //start_frame = 66; // по пр€мой, слева по полосе обгон€ют
#endif
  ...
  ///string data = "/testdata/roadvideo/input/roadvideo.01/roadvideo.01.0029.avi.960.avi"; //- ... ловит тетку в красном
  ///string data = "/testdata/roadvideo/input/roadvideo.01/roadvideo.01.0030.avi.960.avi"; //- периодически цепл€ет красноватый песок
  string data = "/testdata/roadvideo/input/roadvideo.01/roadvideo.01.0031.avi.960.avi"; //- соскакивает...
  ...
  // подходим совсем издалека, есть вид вблизи, есть зеленый, есть круглые, комплексный тест
  //int start_frame = 50; // начинаеnтс€ видео с красного
  //int start_frame = 1600; // светофор переключаетс€ на зеленый_  
  //int start_frame = 1620; // светофор переключаетс€ на зеленый_  
  int start_frame = 1624; // светофор - зеленый - рассыпан на части  
  //int start_frame = 1884; // зеленый чел, но выделилс€ как несколько компонент
#endif
