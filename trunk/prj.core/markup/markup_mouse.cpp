...
int MarkupEditor::finishMouseEvent() // евент обработан, надо отрисовать и закончить его обработку
{
...
int MarkupEditor::processMouseEvent(int event, int x, int y, int flags)
{
