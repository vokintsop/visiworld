...
bool MarkupEditor::addMouseObject( // пытаемся добавить новый объект для набора точек, указанных мышкой 
...
bool MarkupEditor::addMouseObject( // пытаемся добавить новый объект вытянув или кликнув мышкой 
...
bool MarkupEditor::adjustObjectRectangle( 
